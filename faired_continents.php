...
$tempcontinent=$prevcontinent="";

$continents=['Asia'=> [0,0,0], 'Africa' =>[0,0,0], 'Australia'=>[0,0,0], 'Antarctica'=> [0,0,0], 'Europe'=> [0,0,0], 'North_America'=> [0,0,0], 'South_America'=> [0,0,0], 'Others'=> [0,0,0]];


for($i=0; $i <count($countries); $i++ )
{
    $continents[$countries[$i][5]][0]+= (int)$countries[$i][2];
    $continents[$countries[$i][5]][1]+= (int)$countries[$i][3];
    $continents[$countries[$i][5]][2]+= (int)$countries[$i][4];
}
//echo $continents['Asia'][0];
